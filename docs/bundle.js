...
/* harmony import */ var _models_item_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/item.js */ "./src/models/item.js");
...
class API {
  ...
  getItems() {
    return this._load({url: `points`})
      ...
      .then(_models_item_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseItems);
  }
  ...
  updateItem(id, item) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_item_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseItem);
  }
...
class Provider {
  ...
  getItems() {
    ...
    return Promise.resolve(_models_item_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseItems(storeItems));
  }
  ...
  createItem(item) {
    ...
    const localNewItemId = Object(nanoid__WEBPACK_IMPORTED_MODULE_1__["nanoid"])();
    const localNewItem = _models_item_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(item, {id: localNewItemId}));
  ...
  updateItem(id, item) {
    ...
    const localItem = _models_item_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(item, {id}));
...
/***/ "./src/components/list-loading.js":
/*!****************************************!*\
  !*** ./src/components/list-loading.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ListLoading; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class ListLoading extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class NoItem extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
const createFlterMarkup = (filter) => {
  ...
  return (
    `<div class="trip-sort__item  trip-sort__item--${filter.name}">
      ...
      <label class="trip-sort__btn" for="sort-${filter.name}" data="${filter.name}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(filter.name)}</label>
    </div>`
  );
};
...
class Sorting extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters) {
    super();
...
const convertDurationFormat = (ms) => {
  return moment__WEBPACK_IMPORTED_MODULE_5___default.a.duration(ms, `milliseconds`).format(`DD[D] hh[H] mm[M]`);
};
...
const formatDataForChart = (itemsGroup, chartType) => {
  ...
  switch (chartType) {
    case ChartType.TRANSPORT:
      _const_js__WEBPACK_IMPORTED_MODULE_3__["EVENT_TYPES_ACTIVITY"].forEach((type) => delete copyItemsGroup[type]);
...
const moneyChart = (moneyCtx, itemsGroup) => {
  ...
  const eventLabels = events.map((type) => {
    ...
    return `${eventEmoji} ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["capitalize"])(type[0])}`;
  });
...
class Statistics extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _renderCharts() {
    ...
    const groupedItems = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["groupTripItemsByKey"])(items, _const_js__WEBPACK_IMPORTED_MODULE_3__["KeyMap"].TYPE);
...
class TripBoard extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/trip-day-items.js":
/*!******************************************!*\
  !*** ./src/components/trip-day-items.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripDayItems; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class TripDayItems extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
  ...
  if (day) {
    ...
    const shortDate = currentDate
       ...
       .slice(1) // Обрезает год, оставляя только месяц-день (согласно макету)
        .map((element, i) => {
          element = i === 0 ? _const_js__WEBPACK_IMPORTED_MODULE_1__["MONTH_NAMES"][Number(element - 1)] : element;
          return element;
        })
          .join(` `);
...
class TripDay extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripEdit; });
/* harmony import */ var _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component.js */ "./src/components/abstract-smart-component.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
...
const createEventTypesMatkup = (type, eventType) => {
  ...
  return (
    ...
    <label class="event__type-label  event__type-label--${type}" for="event-type-${type}-1">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(type)}</label>
  </div>`
  );
};
...
const createTripEditTemplate = ({id, eventType, destination, price, startEventTime, endEventTime, offers, isFavorite}, OffersMap, DestinationMap, _eexternalButtonData) => {
  ...
  const eventTransferTypesMarkup = _const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES_TRANSPORT"].map((type) => createEventTypesMatkup(type, eventType)).join(`\n`);
  const eventActivityTypesMarkup = _const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES_ACTIVITY"].map((type) => createEventTypesMatkup(type, eventType)).join(`\n`);
  const isEventTypeTransport = _const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES_TRANSPORT"].indexOf(eventType) > -1;
        ...
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            <label class="event__label  event__type-output" for="event-destination-1">
              ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(eventType)} ${(isEventTypeTransport) ? `to` : `in`}
            </label>
           ...
           <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDateTime"])(startEventTime)}">
             &mdash;
            <label class="visually-hidden" for="event-end-time-1">
                To
              </label>
              <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDateTime"])(endEventTime)}">
            </div>
...
class TripEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  changeFormState(state) {
    if (state === _const_js__WEBPACK_IMPORTED_MODULE_2__["FormState"].DISABLED) {
      this.getElement().querySelectorAll(`.event__input, .event__type-toggle, .event__offer-checkbox, .event__favorite-checkbox`)
      .forEach((elem) => {
        elem.setAttribute(_const_js__WEBPACK_IMPORTED_MODULE_2__["FormState"].DISABLED, _const_js__WEBPACK_IMPORTED_MODULE_2__["FormState"].DISABLED);
      });
    }
  }
      ...
      switch (evt.target.name) {
        ...
        case FormChangeMap.START:
          if (this._checkDestinationValue()) {
            this._selectedStartTime = new Date(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getCurrentDateFromValue"])(evt.target.value));
          }
          break;

        case FormChangeMap.END:
          if (this._checkDestinationValue()) {
            this._selectedEndTime = new Date(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getCurrentDateFromValue"])(evt.target.value));
...
const craeteMainFilterMarkup = ({name, count}, activeFilter) => {
  ...
  return (
    `<div class="trip-filters__filter">
      ...
      <label class="trip-filters__filter-label ${isFilterAble ? `` : `trip-filters__filter-label--disabled`}" for="filter-${name}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["capitalize"])(name)}</label>
   </div>`
  );
};
...
const createTripItemTemplate = ({eventType, destination, price, startEventTime, endEventTime, offers}) => {
  const eventDuration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getEventDuration"])(startEventTime, endEventTime);
  ...
  return (
    `<div class="event">
      ...
      <h3 class="event__title">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(eventType)} ${(isEventTypeTransport) ? `to` : `in`} ${destination.name}</h3>
      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDateTime"])(startEventTime)}">${getShortTime(startEventTime)}</time>
            &mdash;
          <time class="event__end-time" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDateTime"])(endEventTime)}">${getShortTime(endEventTime)}</time>
        </p>
...
class TripItem extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(item) {
    super();
...
/***/ "./src/components/trip-items-list.js":
/*!*******************************************!*\
  !*** ./src/components/trip-items-list.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripItemsList; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class TripItemsList extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/trip-main-control.js":
/*!*********************************************!*\
  !*** ./src/components/trip-main-control.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripMainControl; });
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
...
/***/ "./src/components/trip-main-info.js":
/*!******************************************!*\
  !*** ./src/components/trip-main-info.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripMainInfo; });
...
const createTripDurationMarkup = (dates) => {
  ...
  const startDate = `${_const_js__WEBPACK_IMPORTED_MODULE_0__["MONTH_NAMES"][dates[0].getMonth()]} ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getCurrentDateValue"])(dates[0].getDate())}`;
  const endDate = dates[lastDateIndex].getMonth() === dates[0].getMonth() ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getCurrentDateValue"])(dates[lastDateIndex].getDate()) : `${_const_js__WEBPACK_IMPORTED_MODULE_0__["MONTH_NAMES"][dates[lastDateIndex].getMonth()]} ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getCurrentDateValue"])(dates[lastDateIndex].getDate())}`;
  return (
...
const createTripMainInfoTemplate = (items) => {
  ...
  if (items.length > 0) {
    ...
    const tripDates = items
                    ...
                    .sort((a, b) => {
                      if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getSimpleDate"])(a) < Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getSimpleDate"])(b)) {
                        return -1;
                      }
                      if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getSimpleDate"])(a) > Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getSimpleDate"])(b)) {
                        return 1;
...
class TripMainInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(items) {
    super();
    this._items = items;
  }
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EVENT_TYPES_TRANSPORT, EVENT_TYPES_ACTIVITY, MONTH_NAMES, SORT_FILTERS, MAIN_FILTER, FormState, KeyMap, ItemRenderModeMap, MenuItemMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EVENT_TYPES_TRANSPORT", function() { return EVENT_TYPES_TRANSPORT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EVENT_TYPES_ACTIVITY", function() { return EVENT_TYPES_ACTIVITY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MONTH_NAMES", function() { return MONTH_NAMES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SORT_FILTERS", function() { return SORT_FILTERS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAIN_FILTER", function() { return MAIN_FILTER; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemRenderModeMap", function() { return ItemRenderModeMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MenuItemMap", function() { return MenuItemMap; });
const EVENT_TYPES_TRANSPORT = [`taxi`, `bus`, `train`, `ship`, `transport`, `drive`, `flight`];

const EVENT_TYPES_ACTIVITY = [`check-in`, `sightseeing`, `restaurant`];
...
/* harmony import */ var _components_trip_filter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/trip-filter.js */ "./src/components/trip-filter.js");
...
class FilterController {
  constructor(container, itemsModel, tripMainControlComponent) {
    ...
    this.activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_1__["MAIN_FILTER"].ALL;
  ...
  render() {
    ...
    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["MAIN_FILTER"]).map((filter) => {
      return {
        name: filter,
        count: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getItemsByFilter"])(allItems, filter).length,
      };
    });

    this._filterComponent = new _components_trip_filter_js__WEBPACK_IMPORTED_MODULE_3__["default"](filters, this.activeFilter);
...
/*!********************************************!*\
  !*** ./src/controllers/item-controller.js ***!
  \********************************************/
/*! exports provided: EmptyTask, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_trip_day_items_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/trip-day-items.js */ "./src/components/trip-day-items.js");
/* harmony import */ var _components_trip_edit_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/trip-edit.js */ "./src/components/trip-edit.js");
/* harmony import */ var _components_trip_item_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/trip-item.js */ "./src/components/trip-item.js");
...
const parseFormData = (formData, OfferMap, DestinationMap) => {
  ...
  return new _models_item_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    "type": eventType,
    "destination": DestinationMap[formData.get(`event-destination`)],
    "base_price": Number(formData.get(`event-price`)),
    "date_from": new Date(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getCurrentDateFromValue"])(formData.get(`event-start-time`))).toJSON(),
    "date_to": new Date(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getCurrentDateFromValue"])(formData.get(`event-end-time`))).toJSON(),
...
class ItemController {
  constructor(container, onItemChange, onViewChange, onDeleteItem, onNewItem, offerMap, destinationMap) {
    ...
    this.offerMap = offerMap;
    this.destinationMap = destinationMap;
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].DEFAULT;
  ...
  render(item, mode, spesialPlace) {
    ...
    const itemContainer = new _components_trip_day_items_js__WEBPACK_IMPORTED_MODULE_4__["default"]();

    const oldItemComponent = this._itemComponent;
    const oldItemEditComponent = this._itemEditComponent;

    this._itemComponent = new _components_trip_item_js__WEBPACK_IMPORTED_MODULE_6__["default"](item);
    this._itemEditComponent = new _components_trip_edit_js__WEBPACK_IMPORTED_MODULE_5__["default"](item, this.offerMap, this.destinationMap);

    this._setItemHandlers();


    switch (mode) {
      case _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].DEFAULT:
        if (oldItemEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._itemEditComponent, oldItemEditComponent);
          this._replaceEditToItem();
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, itemContainer, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(itemContainer.getElement(), this._itemComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
        }
        break;

      case _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].NEW:
        if (oldItemEditComponent && oldItemComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldItemComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldItemEditComponent);
        }
        this._mode = _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].NEW;
        const container = spesialPlace.parentElement;

        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(container, this._itemEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREELEMENT, spesialPlace);
        document.addEventListener(`keydown`, this._onEscKeyDown);
        break;

      case _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].FIRST:
        this._mode = _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].NEW;
        if (oldItemEditComponent && oldItemComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldItemComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldItemEditComponent);
        }
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._itemEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
        document.addEventListener(`keydown`, this._onEscKeyDown);
        break;
    }
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._itemEditComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._itemComponent);
  ...
  setDefaultView() {
    if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].NEW) {
      this.destroy();
    } else if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].EDIT) {
      this._replaceEditToItem();
    }
  }
  ...
  _setItemHandlers() {
    this._itemEditComponent.setFavoriteButtonClickHandler(() => {
      const newItem = _models_item_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(this._item);
    ...
    this._itemEditComponent.setFormSubmitHandler((evt) => {
      ...
      this._itemEditComponent.changeFormState(_const_js__WEBPACK_IMPORTED_MODULE_1__["FormState"].DISABLED);

      if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].NEW || this._mode === _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].FIRST) {
  ...
  _replaceItemToEdit() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._itemEditComponent, this._itemComponent);
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].EDIT;
  }

  _replaceEditToItem() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._itemComponent, this._itemEditComponent);
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_1__["ItemRenderModeMap"].DEFAULT;
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }
...
/***/ "./src/controllers/main-info-controller.js":
/*!*************************************************!*\
  !*** ./src/controllers/main-info-controller.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MainInfoController; });
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_trip_main_info_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/trip-main-info.js */ "./src/components/trip-main-info.js");
...
class MainInfoController {
  ...
  render() {
    ...
    this._mainInfoComponent = new _components_trip_main_info_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._itemsModel.getItemsAll());
    this._itemsModel.onDataChange(this.rerender);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._mainInfoComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);

  }

  rerender() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._mainInfoComponent);
    this.render();
  }
}
...
/* harmony import */ var _item_controller_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./item-controller.js */ "./src/controllers/item-controller.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _components_trip_day__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/trip-day */ "./src/components/trip-day.js");
/* harmony import */ var _components_trip_days_list_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/trip-days-list.js */ "./src/components/trip-days-list.js");
/* harmony import */ var _components_no_item_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/no-item.js */ "./src/components/no-item.js");
/* harmony import */ var _components_trip_items_list_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/trip-items-list.js */ "./src/components/trip-items-list.js");
...
const renderDayItemsList = ({tripComponent, day, index, items, onItemChange, instans, onViewChange, onDeleteItem, onNewItem, OfferMap, DestinationMap}) => {
  ...
  const tripDayComponent = new _components_trip_day__WEBPACK_IMPORTED_MODULE_3__["default"](day, index);
  const itemListElement = new _components_trip_items_list_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

  const dayItems = (day) ? day[1] : items;

  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(tripComponent, tripDayComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(tripDayComponent.getElement(), itemListElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);

  return dayItems.map((item) => {
    const itemController = new _item_controller_js__WEBPACK_IMPORTED_MODULE_0__["default"](itemListElement.getElement(), onItemChange, onViewChange, onDeleteItem, onNewItem, OfferMap, DestinationMap);

    itemController.render(item, _const_js__WEBPACK_IMPORTED_MODULE_8__["ItemRenderModeMap"].DEFAULT);
...
class TripController {
  ...
  render() {
    if (this._daysComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._daysComponent);
      this._daysComponent = null;
    }

    if (this._sortListComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._sortListComponent);
      this._sortListComponent = null;
    }
    ...
    if (items.length === 0) {
      if (this._itemsModel.getItemsAll().length === 0) {
        this._tripNoItemComponent = new _components_no_item_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._tripNoItemComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
        return;
      }
      this._filterController.onFilterChange(_const_js__WEBPACK_IMPORTED_MODULE_8__["MAIN_FILTER"].ALL);
      return;
    }
  ...
  createNewItem() {
    ...
    this._newItemButton.setAttribute(_const_js__WEBPACK_IMPORTED_MODULE_8__["FormState"].DISABLED, _const_js__WEBPACK_IMPORTED_MODULE_8__["FormState"].DISABLED);

    if (!this.checkIsListItemsFull()) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._tripNoItemComponent);
      this._creatingNewItem = new _item_controller_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._container, this.onItemChange, this.onViewChange, this.onDeleteItem, this.onNewItem, this.offerMap, this.destinationMap);
      this._creatingNewItem.render(Object.assign({}, _item_controller_js__WEBPACK_IMPORTED_MODULE_0__["EmptyTask"]), _const_js__WEBPACK_IMPORTED_MODULE_8__["ItemRenderModeMap"].FIRST);
    } else {
      this._onViewChange();
      this._creatingNewItem = new _item_controller_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._tripDaysListComponent, this.onItemChange, this.onViewChange, this.onDeleteItem, this.onNewItem, this.offerMap, this.destinationMap);
      this._creatingNewItem.render(Object.assign({}, _item_controller_js__WEBPACK_IMPORTED_MODULE_0__["EmptyTask"]), _const_js__WEBPACK_IMPORTED_MODULE_8__["ItemRenderModeMap"].NEW, this._tripDaysListComponent);
    }
  ...
  _renderDayListComponent() {
    this._daysComponent = new _components_trip_days_list_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._tripDaysListComponent = this._daysComponent.getElement();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._daysComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
  }

  _renderSortFltersComponent() {
    this._sortListComponent = new _components_sorting_js__WEBPACK_IMPORTED_MODULE_7__["default"](_const_js__WEBPACK_IMPORTED_MODULE_8__["SORT_FILTERS"]);
    this._sortListComponent.setSortTypeChangeHandler(this._onSortTypeChange);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._sortListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
  }

  _renderItems(items) {
    const groupedItems = Object.entries(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["groupTripItemsByKey"])(items, _const_js__WEBPACK_IMPORTED_MODULE_8__["KeyMap"].START)).sort();
  ...
  _setButtonAbleStat(button) {
    button.removeAttribute(_const_js__WEBPACK_IMPORTED_MODULE_8__["FormState"].DISABLED);
    this._creatingNewItem = null;
  }
  ...
  _onNewItem(item, itemController) {
    this._api.createItem(item)
      ...
      .catch(() => {
        itemController.shake();
        itemController.changeFormState(_const_js__WEBPACK_IMPORTED_MODULE_8__["FormState"].ENABLED);
      });
  }
...
/* harmony import */ var _models_items_model_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/items-model.js */ "./src/models/items-model.js");
/* harmony import */ var _components_list_loading_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/list-loading.js */ "./src/components/list-loading.js");
/* harmony import */ var _controllers_main_info_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/main-info-controller.js */ "./src/controllers/main-info-controller.js");
...
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
...
/* harmony import */ var _components_trip_board_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/trip-board.js */ "./src/components/trip-board.js");
...
/* harmony import */ var _components_trip_main_control_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/trip-main-control.js */ "./src/components/trip-main-control.js");
...
const AUTHORIZATION = window.localStorage.getItem(`authToken`) || `Basic ${Object(nanoid__WEBPACK_IMPORTED_MODULE_6__["nanoid"])()}`;
...
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_7__["default"](api, store);

const itemsModel = new _models_items_model_js__WEBPACK_IMPORTED_MODULE_2__["default"]();

const listLoadingComponent = new _components_list_loading_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_9__["default"](itemsModel);
const tripBoardComponent = new _components_trip_board_js__WEBPACK_IMPORTED_MODULE_11__["default"]();
const tripMainControlComponent = new _components_trip_main_control_js__WEBPACK_IMPORTED_MODULE_13__["default"]();


const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_1__["default"](siteHeaderMenuElement, itemsModel, tripMainControlComponent);
const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_12__["default"](tripBoardComponent, itemsModel, apiWithProvider, newItemButton, filterController);
const tripMainInfoController = new _controllers_main_info_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteHeaderTripElement, itemsModel);


Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(siteHeaderMenuElement, tripMainControlComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(siteMainEventElement, tripBoardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(siteMainEventElement, statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripBoardComponent.getElement(), listLoadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
...
tripMainControlComponent.setOnControlClickHandler((MenuItem) => {
  switch (MenuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItemMap"].STATS:
      tripBoardComponent.hide();
      statisticsComponent.show();
      filterController.activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_5__["MAIN_FILTER"].ALL;
      filterController.rerender();
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItemMap"].TABLE:
      statisticsComponent.hide();
...
newItemButton.addEventListener(`click`, () => {
  if (tripController.checkIsListItemsFull()) {
    filterController.onFilterChange(_const_js__WEBPACK_IMPORTED_MODULE_5__["MAIN_FILTER"].ALL);
    filterController.rerender();
  }
  statisticsComponent.hide();
  tripBoardComponent.show();
...
Promise.all([
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["remove"])(listLoadingComponent);
  filterController.rerender();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ItemsModel; });
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
...
class ItemsModel {
  constructor() {
    ...
    this._activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_2__["MAIN_FILTER"].ALL;
  }

  getItems() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_1__["getItemsByFilter"])(this._items, this._activeFilter);
  }
  ...
  setOffers(offers) {
    this._offersMap = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["createOffersMap"])(offers);
  }
  ...
  setDestinations(destinations) {
    this._destinationsMap = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["createDestinationsMap"])(destinations);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getCurrentDateValue, getSimpleDate, createElement, groupTripItemsByKey, capitalize, getDateTime, createOffersMap, createDestinationsMap, getEventDuration, getCurrentDateFromValue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCurrentDateValue", function() { return getCurrentDateValue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSimpleDate", function() { return getSimpleDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createElement", function() { return createElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "groupTripItemsByKey", function() { return groupTripItemsByKey; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createOffersMap", function() { return createOffersMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createDestinationsMap", function() { return createDestinationsMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEventDuration", function() { return getEventDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCurrentDateFromValue", function() { return getCurrentDateFromValue; });
...
const getEventDuration = (start, end) => {
  ...
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duretionMs, `milliseconds`).format(`DD[D] hh[H] mm[M]`);
};
...
const getDateTime = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`YYYY-MM-DDThh:mm`);
};
...
const groupTripItemsByKey = (items, key) =>
  items.reduce((accumulator, item) => {
    const resultKey = key === _const_js__WEBPACK_IMPORTED_MODULE_1__["KeyMap"].START ? getSimpleDate(item[key]) : item[key];
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getItemsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getItemsByFilter = (items, filter) => {
  const nowDate = new Date();
  switch (filter) {
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["MAIN_FILTER"].PAST:
      return getNotCurrentItems(items, nowDate, `past`);
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["MAIN_FILTER"].FUTURE:
